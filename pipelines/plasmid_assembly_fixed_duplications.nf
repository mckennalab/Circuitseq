...
Channel.fromPath( params.samplesheet )
        ...
        .into{sample_table; sample_table_rotation; sample_table_assessment; sample_table_print}
...
process FilterReads {
    ...
    """
    gunzip -c ${tofilter} | NanoFilt --quality 10 --length 1000 --summary ${summary} | gzip > ${datasetID}_filtered.fq.gz
    """
}
